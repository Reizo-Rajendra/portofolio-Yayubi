<?php
// Database dan Controller dimatikan sementara demi kelancaran tes tampilan
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Kita bypass/matikan proses simpan ke database-nya
    // $result = $userController->handleRegister($username, $email, $password );
    
    // BEGITU DAFTAR DIKLIK, LANGSUNG KELUAR FOLDER MENUJU home.html
